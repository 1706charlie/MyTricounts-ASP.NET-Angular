...
export class AuthGuard implements CanActivate {
    constructor(
        private router: Router, // injection de dépendance
        private authenticationService: AuthenticationService // injection de dépedance authencationService (voir commentaire classe authentication.service)
    ) { }
